...
namespace TakeCare.Migration.OpenEhr.CareDocumentation.Transformer.Models
{
    internal record News2TotalScoreHeartRate
    {
        ...
        //static constructor
        static News2TotalScoreHeartRate()
        {
            _unitService = new UnitProvider();
        }

        public static void AddTotalScoreHeartRateData(JObject composedObject, KeywordDto keyword, int v, string commonPrefix, TerminologyDetails termData)
        {
