...
namespace TakeCare.Migration.OpenEhr.CareDocumentation.Transformer.Models
{
    internal record HeightLyingDown
    {
        ...
        public HeightLyingDown(IUnitProvider unitService)
        {
            _unitService = unitService;
        }

        public static void AddHeightLyingDownData(JObject composedObject, KeywordDto keyword, int v, string commonPrefix)
        {
            ...
            composedObject[$"{prefix}{v}{"/kroppslängd|magnitude"}"] = (keyword.Value != null) ? ((keyword.Value.NumVal != null) ? keyword.Value.NumVal.Val : keyword.Value.TextVal) : "";
            composedObject[$"{prefix}{v}{"/kroppslängd|unit"}"] = (keyword.Value != null) ? ((keyword.Value.NumVal != null) ? keyword.Value.NumVal.Unit : "") : "";
            composedObject[$"{prefix}{v}{"/kroppslängd|code"}"] = "at0012";
