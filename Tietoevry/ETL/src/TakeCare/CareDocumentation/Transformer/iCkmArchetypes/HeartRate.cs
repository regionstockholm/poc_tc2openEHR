...
namespace TakeCare.Migration.OpenEhr.CareDocumentation.Transformer.Models
{
    internal record HeartRate
    {
        ...
        public static void AddHeartRateData(JObject composedObject, KeywordDto keyword, int v, string commonPrefix, TerminologyDetails termData)
        {
            StringBuilder prefixBuilder = new StringBuilder(commonPrefix);
            prefixBuilder.Append("ickm/hjärtfrekvens");
            ...
            if (keyword.Value!=null && keyword.Value.NumVal != null)
            {
                ...
                {
                    throw new System.Exception("Heart Rate : Unit is missing");
                }
            }
