...
namespace TakeCare.Migration.OpenEhr.CareDocumentation.Transformer.Models
{
    internal record SaturationWithOxygen
    {
        ...
        public SaturationWithOxygen(IUnitProvider unitService)
        {
            _unitService = unitService;
        }

        public static void AddSaturationWithOxygenData(JObject composedObject, KeywordDto keyword, int v, string commonPrefix)
        {
