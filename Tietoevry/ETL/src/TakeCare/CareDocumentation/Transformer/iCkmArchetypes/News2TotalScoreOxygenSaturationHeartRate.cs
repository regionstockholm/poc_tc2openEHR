...
namespace TakeCare.Migration.OpenEhr.CareDocumentation.Transformer.Models
{
    internal record News2TotalScoreOxygenSaturationHeartRate
    {
        ...
        //static constructor
        static News2TotalScoreOxygenSaturationHeartRate()
        {
            _unitService = new UnitProvider();
        }

        public static void AddTotalScoreOxygenSaturationHeartRateData(JObject composedObject, KeywordDto keyword, int v, string commonPrefix, TerminologyDetails termData)
        {
            StringBuilder prefixBuilder = new StringBuilder(commonPrefix);
            prefixBuilder.Append("ickm/news2_totalpoäng_syremättnad2_hjärtfrekvens");
