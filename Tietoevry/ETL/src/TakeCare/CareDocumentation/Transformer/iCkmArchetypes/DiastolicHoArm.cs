...
namespace TakeCare.Migration.OpenEhr.CareDocumentation.Transformer.iCkmArchetypes
{
    internal record DiastolicHoArm
    {
        ...
        public DiastolicHoArm(IUnitProvider unitService)
        {
            _unitService = unitService;
        }

        public static void AddDiastolicHoArmData(JObject composedObject, KeywordDto keyword, int v, string commonPrefix)
        {
