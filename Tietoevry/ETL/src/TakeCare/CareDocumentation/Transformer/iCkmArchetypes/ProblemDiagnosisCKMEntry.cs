...
{
    public static void AddProblemDiagnosisData(JObject composedObject, KeywordDto keyword, int v, string keywordname, string commonPrefix)
    {
        ...
        composedObject[$"{prefix}{v}{"/problem_diagnos_namn"}"] = (keyword.Value != null) ? ((keyword.Value.NumVal != null) ? keyword.Value.NumVal.Val : keyword.Value.TextVal) : "";
