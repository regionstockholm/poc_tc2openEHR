...
namespace TakeCare.Migration.OpenEhr.CareDocumentation.Transformer.iCkmArchetypes
{
    internal record DiastolicInvasive
    {
        ...
        public DiastolicInvasive(IUnitProvider unitService)
        {
            _unitService = unitService;
        }

        public static void AddDiastolicData(JObject composedObject, KeywordDto keyword, int v, string commonPrefix)
        {
