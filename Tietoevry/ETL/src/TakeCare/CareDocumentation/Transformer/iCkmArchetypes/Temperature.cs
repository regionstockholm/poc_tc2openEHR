...
namespace TakeCare.Migration.OpenEhr.CareDocumentation.Transformer.Models
{
    internal record Temperature
    {
        ...
        public static void AddTemperatureData(JObject composedObject, KeywordDto keyword, int v, string commonPrefix, TerminologyDetails termData)
        {
            ...
            if (keyword.Value != null && keyword.Value.NumVal != null)
            {
                if (!string.IsNullOrEmpty(keyword.Value.NumVal.Unit))
                {
                    ...
                    composedObject[$"{prefix}{v}{"/temperatur|magnitude"}"] = keyword.Value.NumVal.Val;
                    composedObject[$"{prefix}{v}{"/temperatur|unit"}"] = openEhrUnit;
                ...
                else
                {
                    ...
                    {
                        throw new System.Exception("Temperature : Unit is missing");
                    }
                }
            }
