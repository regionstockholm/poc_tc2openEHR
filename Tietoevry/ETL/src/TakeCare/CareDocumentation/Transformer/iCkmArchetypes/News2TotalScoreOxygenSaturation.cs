...
namespace TakeCare.Migration.OpenEhr.CareDocumentation.Transformer.Models
{
    internal record News2TotalScoreOxygenSaturation
    {
        ...
        //static constructor
        static News2TotalScoreOxygenSaturation()
        {
            _unitService = new UnitProvider();
        }

        public static void AddTotalScoreOxygenSaturationData(JObject composedObject, KeywordDto keyword, int v, string commonPrefix, TerminologyDetails termData)
        {
