...
namespace TakeCare.Migration.OpenEhr.CareDocumentation.Transformer.iCkmArchetypes
{
    internal record SystolicVaArm
    {
        ...
        //static constructor
        static SystolicVaArm()
        {
            _unitService = new UnitProvider();
            _lookupProvider = new TerminologyProvider();
        }

        public static void AddSystolicVaArmData(JObject composedObject, KeywordDto keyword, int v, string commonPrefix, TerminologyDetails termData)
        {
            ...
            if (keyword.Value!=null && keyword.Value.NumVal != null)
            {
                ...
                {
                    throw new System.Exception("SystolicVaArm : Unit is missing");
                }
