...
{
    internal record SystomlicHoArm
    {
        private readonly IUnitProvider _unitService;

        public SystomlicHoArm(IUnitProvider unitService)
        {
            _unitService = unitService;
        }


        public static void AddSystolicHoArmData(JObject composedObject, KeywordDto keyword, int v, string commonPrefix)
        {
