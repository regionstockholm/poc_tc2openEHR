...
{
    internal record HeightCKMEntry
    {
        public static void AddHeightData(JObject composedObject, KeywordDto keyword, int v, string keywordname, string commonPrefix)
        {
            StringBuilder prefixBuilder = new StringBuilder(commonPrefix);
            prefixBuilder.Append("ickm/");
            prefixBuilder.Append(keywordname);
