...
namespace TakeCare.Migration.OpenEhr.CareDocumentation.Transformer.Models
{
    internal record RespiratoryRate
    {
        ...
        public RespiratoryRate(IUnitProvider unitService)
        {
            _unitService = unitService;
        }

        public static void AddRespiratoryRateData(JObject composedObject, KeywordDto keyword, int v, string commonPrefix)
        {
