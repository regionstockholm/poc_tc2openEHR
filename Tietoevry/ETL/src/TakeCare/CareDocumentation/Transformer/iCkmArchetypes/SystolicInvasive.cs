...
namespace TakeCare.Migration.OpenEhr.CareDocumentation.Transformer.iCkmArchetypes
{
    internal record SystolicInvasive
    {
        ...
        public SystolicInvasive(IUnitProvider unitService)
        {
            _unitService = unitService;
        }

        public static void AddInvasiveSystolicData(JObject composedObject, KeywordDto keyword, int v, string commonPrefix)
        {
