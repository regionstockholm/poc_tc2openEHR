...
namespace TakeCare.Migration.OpenEhr.CareDocumentation.Transformer.Models
{
    internal record PulseRate
    {
        ...
        public static void AddPulseRateData(JObject composedObject, KeywordDto keyword, int v, string commonPrefix, TerminologyDetails termData)
        {
            ...
            if (keyword.Value != null && keyword.Value.NumVal != null)
            {
                ...
                {
                    throw new Exception("Pulse Rate : Unit is missing");
                }
            }
