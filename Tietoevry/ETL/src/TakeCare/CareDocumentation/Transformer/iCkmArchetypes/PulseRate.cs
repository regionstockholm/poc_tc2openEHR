...
{
    internal record HeartRate
    {
        private readonly IUnitProvider _unitService;

        public HeartRate(IUnitProvider unitService)
        {
            _unitService = unitService;
        }

        public static void AddHeartRateData(JObject composedObject, KeywordDto keyword, int v, string commonPrefix)
        {
