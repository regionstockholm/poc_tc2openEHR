...
namespace TakeCare.Migration.OpenEhr.CareDocumentation.Transformer.Models
{
    internal record Height
    {
        ...
        public Height(IUnitProvider unitService)
        {
            _unitService = unitService;
        }

        public static void AddHeightData(JObject composedObject, KeywordDto keyword, int v, string commonPrefix)
        {
            StringBuilder prefixBuilder = new StringBuilder(commonPrefix);
            prefixBuilder.Append("ickm/längd");
